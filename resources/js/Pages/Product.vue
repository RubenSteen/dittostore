<template>
	...
	<div class="mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
		...
		<div class="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
			...
			<div class="w-full max-w-2xl mx-auto mt-16 lg:max-w-none lg:mt-0 lg:col-span-4 pb-6">
				<TabGroup as="div">
		...
		<!-- Reviews -->
		<div class="max-w-2xl mx-auto py-16 sm:py-24 lg:max-w-7xl lg:py-16 lg:grid lg:grid-cols-12 lg:gap-x-8 border-t border-b border-gray-200">
			...
			<div class="mt-16 lg:mt-0 lg:col-start-6 lg:col-span-7">
				...
				<a
					href="#"
					class="mt-16 inline-flex w-full bg-white border border-gray-300 rounded-md py-2 px-8 items-center justify-center text-sm font-medium text-gray-900 hover:bg-gray-50 sm:w-auto lg:w-full"
					>View all</a
				>
			</div>
		</div>
		...
		<!-- You may also like -->
		<div class="max-w-2xl mx-auto py-16 px-4 sm:py-16 lg:max-w-7xl">
			<div class="flex items-center justify-between space-x-4">
				<h2 class="text-lg font-medium text-gray-900">You may also like</h2>
