			...
			<div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
				...
				<div>
					<div class="mt-10">
						...
						<a href="#" class="inline-block text-center bg-indigo-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-indigo-700"
							>Shop Collection</a
						>
					</div>
				</div>
		...
		<div class="relative bg-gray-800 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
			...
			<div class="relative max-w-3xl mx-auto flex flex-col items-center text-center">
				...
				<p class="mt-3 text-xl text-white">
					We're committed to responsible, sustainable, and ethical manufacturing. Our small-scale approach allows us to focus on quality and reduce our impact.
